...
| 2 | **Claude Code Supervisor** — spawn `claude` via Agent SDK; replaces echo stub | `02-claude-code-supervisor.md` + `02-claude-code-supervisor-spec.md` + `02-claude-code-supervisor-tasks.md` | ✅ done (Apr 2026) — merged to `develop/v2.0` |
