...
- REQUIRED READING: `${CLAUDE_PLUGIN_ROOT}/knowledge/06-mobile-optimization.md` — complete profiling workflow (Unity Profiler, Memory Profiler, Frame Debugger, Xcode Instruments, Android GPU Inspector), device-tier budgets, CPU/GPU/memory optimization techniques.
