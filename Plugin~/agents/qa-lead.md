...
- REQUIRED READING: `${CLAUDE_PLUGIN_ROOT}/knowledge/09-dependency-injection-testing.md` — complete testing guide with VContainer/Zenject DI for testable code, NUnit fixtures, NSubstitute mocking, testing pyramid (unit/integration/play mode), and pragmatic TDD approach.
