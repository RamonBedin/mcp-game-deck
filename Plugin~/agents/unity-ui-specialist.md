...
- REQUIRED READING: `${CLAUDE_PLUGIN_ROOT}/knowledge/08-unity-ui-ux.md` — complete UI guide with UI Stack pattern (push/pop/replace), MVP/MVVM implementations, Canvas splitting for performance, virtualized ScrollView, safe area handling, and UI Toolkit vs uGUI comparison matrix.
